...
data <- data.frame(
  ...
  `Year 2000` = c(18.0, 18.0, 16.0, 15.0, 15.0, 11.0, 14.0, 16.0, 16.0, 11.0),
  `Year 2016` = c(27.0, 24.0, 22.0, 20.0, 18.0, 17.0, 17.0, 17.0, 17.0, 17.0)
)

# Create a kable table with kableExtra styling
kable(data, "html", caption = "10th highest teacher-to-school municipalities") %>%
  kable_styling(full_width = FALSE, position = "center") %>%
  column_spec(1, bold = TRUE) %>%
  column_spec(2, italic = FALSE) %>%
  row_spec(0, bold = TRUE, color = "white", background = "#cccb88") 
```
