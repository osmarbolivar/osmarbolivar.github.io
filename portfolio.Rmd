...
<div class="band full">
  ...
  <div class="bandContent gallerySection">
    ...
    <div class="galleryItems">
      ...
      <div class="galleryItem">
        <a href="Education.html"><img class="galleryItemImage" src="images/back-to-school.jpg"/></a>
        <a href="Education.html" class="galleryItemLabel">Education in Bolivia</a>
        <div class="galleryItemDescription">Shedding light on the strides made in providing accessible education, disparities, and the ongoing efforts to optimize the allocation of resources.</div>
      </div>
    </div>
  </div>
