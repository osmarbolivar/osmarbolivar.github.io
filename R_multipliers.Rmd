...
![FIGURE 1. GVP Multipliers by activity](Files_multipliers/multip_gvp.png)
...
![FIGURE 2. VA Multipliers by activity](Files_multipliers/multip_va.png)
<div style="margin-bottom: 30px;"></div>
...
![FIGURE 3. Employment Multipliers by activity](Files_multipliers/multip_employment.png)
<div style="margin-bottom: 30px;"></div>  
...
[^1]: Bolivar, O. (2022).[***"Efecto Multiplicador: Evidencia empírica para una asignación costo-efectiva de la inversión pública"***](https://osmarbolivar.weebly.com/uploads/1/4/5/6/145648625/multiplicadores.pdf). Cuadernos de Investigación Económica Boliviana, 5(2): 7-64.
